...
(function(){
    ...
    'use strict';
    angular.module('app.twitcrawler',['angle'])
        .controller("FormSubmitController", FormSubmitController);

    FormSubmitController.$inject = ['$scope','$http'];
    function FormSubmitController($scope,$http){
        this.submitForm = function()
        {
            console.log("Submitting Form");
            $http.get('http://localhost:8080/twitter',  {params: {"profileName": $scope.requestObject.profileName}}).success(function(data){
